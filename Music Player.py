...
def addsongs():
    ...
    for s in temp_song:
        s=s.replace("C:/Users/Admin/Music/Memu Music/","")
...
def Play():
    ...
    song=f'C:/Users/Admin/Music/Memu Music/{song}'
...
def Previous():
    ...
    temp2=f'C:/Users/Admin/Music/Memu Music/{temp2}'
...
def Next():
    ...
    temp=f'C:/Users/Admin/Music\Memu Music/{temp}'
...
songs_list=Listbox(root,selectmode=SINGLE,bg="orange",fg="cyan",font=('Amasis MT Pro Black',25),height=15,width=30,selectbackground="gray",selectforeground="black")
